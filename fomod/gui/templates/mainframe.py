...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.property_editor_view = QtWidgets.QTreeWidget(self.dockWidgetContents)
        self.property_editor_view.setTabKeyNavigation(False)
        self.property_editor_view.setProperty("showDropIndicator", True)
        self.property_editor_view.setAlternatingRowColors(True)
        self.property_editor_view.setTextElideMode(QtCore.Qt.ElideRight)
        self.property_editor_view.setAutoExpandDelay(-1)
        self.property_editor_view.setIndentation(18)
        self.property_editor_view.setRootIsDecorated(True)
        self.property_editor_view.setUniformRowHeights(True)
        self.property_editor_view.setItemsExpandable(True)
        self.property_editor_view.setAnimated(True)
        self.property_editor_view.setAllColumnsShowFocus(False)
        self.property_editor_view.setColumnCount(2)
        self.property_editor_view.setObjectName("property_editor_view")
        self.property_editor_view.header().setVisible(True)
        self.property_editor_view.header().setDefaultSectionSize(110)
        self.property_editor_view.header().setMinimumSectionSize(50)
        self.property_editor_view.header().setStretchLastSection(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.property_editor_view.setSortingEnabled(False)
        self.property_editor_view.headerItem().setText(0, _translate("MainWindow", "Property"))
        self.property_editor_view.headerItem().setText(1, _translate("MainWindow", "Value"))
