...
# Form implementation generated from reading ui file 'resources/templates/mainframe.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.object_tree.setEnabled(True)
        self.object_tree.setMinimumSize(QtCore.QSize(250, 222))
        self.object_tree.setFloating(False)
        self.object_tree.setFeatures(QtWidgets.QDockWidget.AllDockWidgetFeatures)
        ...
        self.wizard_button = QtWidgets.QPushButton(self.dockWidgetContents_2)
        self.wizard_button.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.wizard_button.sizePolicy().hasHeightForWidth())
        self.wizard_button.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.wizard_button.setFont(font)
        self.wizard_button.setCheckable(False)
        self.wizard_button.setFlat(False)
        self.wizard_button.setObjectName("wizard_button")
        self.verticalLayout_2.addWidget(self.wizard_button)
        ...
        self.object_tree_view.setAcceptDrops(True)
        self.object_tree_view.setDragEnabled(True)
        self.object_tree_view.setDragDropMode(QtWidgets.QAbstractItemView.InternalMove)
        self.object_tree_view.setDefaultDropAction(QtCore.Qt.MoveAction)
        self.object_tree_view.setIndentation(10)
        self.object_tree_view.setHeaderHidden(True)
        self.object_tree_view.setObjectName("object_tree_view")
        self.verticalLayout_2.addWidget(self.object_tree_view)
        ...
        self.object_box.setMinimumSize(QtCore.QSize(250, 83))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../logos/logo_open_file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../logos/logo_floppy_disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../logos/logo_gear.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../logos/logo_refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../logos/logo_cross.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../logos/logo_info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../logos/logo_copy.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCopy.setIcon(icon7)
        self.actionCopy.setObjectName("actionCopy")
        self.actionPaste = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../logos/logo_paste.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabWidgetPage2), _translate("MainWindow", "XML Code"))
        ...
        self.object_tree.setStatusTip(_translate("MainWindow", "The tree containing all the existing nodes."))
        self.object_tree.setWindowTitle(_translate("MainWindow", "Object Tree"))
        self.wizard_button.setText(_translate("MainWindow", "Start Wizard"))
        self.object_box.setStatusTip(_translate("MainWindow", "A list with the possible nodes to add."))
