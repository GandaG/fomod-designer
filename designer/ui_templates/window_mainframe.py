...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionHide_Node = QtWidgets.QAction(MainWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("../logos/logo_hide.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHide_Node.setIcon(icon15)
        self.actionHide_Node.setObjectName("actionHide_Node")
        self.actionShow_Node = QtWidgets.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("../logos/logo_show.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShow_Node.setIcon(icon16)
        self.actionShow_Node.setObjectName("actionShow_Node")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionHide_Node.setText(_translate("MainWindow", "Hide Node"))
        self.actionHide_Node.setToolTip(_translate("MainWindow", "Hide Node"))
        self.actionHide_Node.setShortcut(_translate("MainWindow", "Ctrl+X"))
        self.actionShow_Node.setText(_translate("MainWindow", "Show Node"))
        self.actionShow_Node.setToolTip(_translate("MainWindow", "Show Node"))
        self.actionShow_Node.setShortcut(_translate("MainWindow", "Ctrl+X"))
